    ...
    */
    ...
    'stores' => [
        ...
        'taxonomies' => [
            ...
            'directory' => storage_path('content/taxonomies'),
        ],
        ...
        'collections' => [
            ...
            'directory' => storage_path('content/collections'),
        ],
        ...
        'navigation' => [
            ...
            'directory' => storage_path('content/navigation'),
        ],

        'collection-trees' => [
            'class' => Stores\CollectionTreeStore::class,
            'directory' => storage_path('content/trees/collections'),
        ],

        'nav-trees' => [
            'class' => Stores\NavTreeStore::class,
            'directory' => storage_path('content/trees/navigation'),
        ],

        'globals' => [
            'class' => Stores\GlobalsStore::class,
            'directory' => storage_path('content/globals'),
        ],
        ...
        'asset-containers' => [
            ...
            'directory' => storage_path('content/assets'),
        ],
